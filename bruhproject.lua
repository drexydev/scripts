...
aimButton.Text = "PRESS TO OPEN MENU"
...
playerButton.Text = "PRESS TO OPEN"
...
silentButton.Text = "PRESS TO OPEN MENU"
...
silentButton.MouseButton1Down:connect(function()
	...
	silentButton.BackgroundColor3 = Color3.fromRGB(113, 255, 48)
end)
...
StarterGui:SetCore("SendNotification", {
	Title = "GLOOP";
	Text = "GLOOP Project Delta Activated."
})
